...
- **CRIT-208-001 — DESIGN_BLOCKER:** The existing UploadThing integration returns `file.url` values from `src/app/api/uploadthing/core.ts`. REN-208 requires private, non-guessable, authorization-checked agreement delivery. The specification must not approve a public UploadThing URL as the stored agreement location. References: REQ-208-006, SCN-208-006, INV-208-005, DEC-208-001.
...
`BLOCKED` until DEC-208-001 is approved. Do not implement a public-link or URL-proxy workaround that fails the private-object requirement.
