...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "back_in_stock_requests_product_idx" ON "back_in_stock_requests" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "back_in_stock_requests_variant_idx" ON "back_in_stock_requests" USING btree ("variant_id");--> statement-breakpoint
