...
export function ElevateYourLooks({
 ...
 {/* =====================  MOBILE VIEW (desktop layout but smaller) ===================== */}
  ...
  >
    <CarouselContent className="-ml-2">
      {shopByCategories.map((category, index) => (
        <CarouselItem
          key={index}
          className="pl-2 basis-1/3 min-w-0"
        >
          <Link
          ...
          >
            <div className="rounded-full overflow-hidden w-full aspect-square mb-1">
              <div className="rounded-full overflow-hidden mx-auto w-[100px] h-[100px]">
                <Image
            ...
            <p className="text-sm font-normal uppercase text-gray-800 text-center">
