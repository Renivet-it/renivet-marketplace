        ...
        >
            <div className=" mx-auto px-2 md:px-6">
                ...
                <Carousel
                    ...
                    className="w-full"
                >
                    <CarouselContent className="ml-0 flex justify-start gap-4 md:gap-6">
                        {banners.map((item, index) => (
                            <CarouselItem
                                key={index}
                                className="basis-auto p-0 flex justify-center"
                                style={{ width: "252px", height: "315px" }}
                            >
                                <div className="relative w-[252px] h-[315px] overflow-hidden rounded-2xl shadow-md">
                                    <Link href={item.url || "/shop"} className="block w-full h-full">
                                        <Image
                                            ...
                                            priority={index === 0}
                                            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 252px"
                                        />
                                    </Link>
                                </div>
                            </CarouselItem>
