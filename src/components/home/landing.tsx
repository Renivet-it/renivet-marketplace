...
import { Home, ChevronRight, Search, Mic } from "lucide-react";
...
export function Landing({ className, banners, ...props }: PageProps) {
    ...
    const mobileAspectRatio = 375 / 487; // The new aspect ratio for mobile
    const mobileImageUrl = "https://4o4vm2cu6g.ufs.sh/f/HtysHtJpctzNuJOrQshnjfTvXWe4YdlSzoaZPyC7xGVghIDL";
