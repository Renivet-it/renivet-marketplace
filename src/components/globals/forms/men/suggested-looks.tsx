...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.menSuggestedLooksSectionRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
    // @ts-ignore
        trpc.general.content.menSuggestedLooksSectionRouter.updateHomeShopByCategory.useMutation();
    ...
    const { mutate: createBrandProduct, isPending: isCreating } = useMutation({
        ...
        onSuccess: (_, __, { toastId }) => {
            ...
            router.push("/dashboard/general/men-section/suggested-looks");
