...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.menElavateLooksSectionRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
    // @ts-ignore

        trpc.general.content.menElavateLooksSectionRouter.updateHomeShopByCategory.useMutation();
    ...
    const { mutate: createBrandProduct, isPending: isCreating } = useMutation({
        ...
        onSuccess: (_, __, { toastId }) => {
            ...
            router.push("/dashboard/general/men-section/elevate-looks");
