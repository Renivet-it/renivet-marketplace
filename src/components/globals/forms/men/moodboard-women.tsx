...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.menMoodBoardSectionRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
    // @ts-ignore
        trpc.general.content.menMoodBoardSectionRouter.updateHomeShopByCategory.useMutation();
    ...
    const { mutate: createBrandProduct, isPending: isCreating } = useMutation({
        ...
        onSuccess: (_, __, { toastId }) => {
            ...
            router.push("/dashboard/general/women-section/mood-board");
