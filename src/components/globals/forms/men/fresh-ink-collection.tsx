...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.menFresInkSectionRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
    // @ts-ignore
        trpc.general.content.menFresInkSectionRouter.updateWomenBanner.useMutation();
    ...
    const { mutate: createBrandProduct, isPending: isCreating } = useMutation({
        ...
        onSuccess: (_, __, { toastId }) => {
            ...
            router.push("/dashboard/general/men-section/outfit-varients");
