...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.newHomePageFirstConciousRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
        trpc.general.content.newHomePageFirstConciousRouter.updateWomenBanner.useMutation();
