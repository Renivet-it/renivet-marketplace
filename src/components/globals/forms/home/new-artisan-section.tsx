...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.newHomePageArtisanRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
        trpc.general.content.newHomePageArtisanRouter.updateWomenBanner.useMutation();
