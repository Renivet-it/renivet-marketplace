...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.newHomePageTrustedBannerRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
        trpc.general.content.newHomePageTrustedBannerRouter.updateWomenBanner.useMutation();
