...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.newHomePagEventSectionOneRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
        trpc.general.content.newHomePagEventSectionOneRouter.updateWomenBanner.useMutation();
