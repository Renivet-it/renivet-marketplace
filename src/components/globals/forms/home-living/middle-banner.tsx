...
export function ShopByCategoryManageForm({ shopByCategory }: PageProps) {
    ...
    const { mutateAsync: createAdAsync } =
        trpc.general.content.homeAndLivingBannerMiddlecollectionRouter.createWomenBanner.useMutation();
    const { mutateAsync: updateAdAsync } =
        trpc.general.content.homeAndLivingBannerMiddlecollectionRouter.updateWomenBanner.useMutation();
