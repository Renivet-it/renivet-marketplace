...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.womenBrandStoryTellingRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.womenBrandStoryTellingRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
