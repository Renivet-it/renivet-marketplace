...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.womenBrandSeasonalSaleRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.womenBrandSeasonalSaleRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
