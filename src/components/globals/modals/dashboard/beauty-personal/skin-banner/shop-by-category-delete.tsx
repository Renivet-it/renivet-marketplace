...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.beautySkinCareBannerRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.beautySkinCareBannerRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
