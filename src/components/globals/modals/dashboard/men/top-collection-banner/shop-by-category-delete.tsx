...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.menTopcollectionBannerRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.menTopcollectionBannerRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
