...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.newHomePageBagSectionRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.newHomePageBagSectionRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
