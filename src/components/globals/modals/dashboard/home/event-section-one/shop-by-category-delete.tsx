...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.newHomePagEventSectionOneRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.newHomePagEventSectionOneRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
