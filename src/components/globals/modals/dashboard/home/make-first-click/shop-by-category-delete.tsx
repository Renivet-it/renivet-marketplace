...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.newHomePageFirstConciousRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.newHomePageFirstConciousRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
