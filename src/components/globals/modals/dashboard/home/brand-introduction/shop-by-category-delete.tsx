...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.newHomePageBrandIntroRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.newHomePageBrandIntroRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
