...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.newHomePagEffortlessRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.newHomePagEffortlessRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
