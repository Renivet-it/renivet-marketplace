...
export function ShopByCategoryDeleteModal({
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.homeShopByCategories.deleteHomeShopByCategory.useMutation(
            {
                onMutate: () => {
    ...
    return (
        <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>
                        Are you sure you want to delete this shop by category?
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                        Deleting this shop by category will remove it from the
