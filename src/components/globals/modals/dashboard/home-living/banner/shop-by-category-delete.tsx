...
export function ShopByCategoryDeleteModal({
    ...
    const { refetch } =
        trpc.general.content.homeAndLivingBannerRouter.getwomenHomeBanners.useQuery(
            {
                page,
                limit,
            }
    ...
    const { mutate: deleteShopByCategory, isPending: isDeleting } =
        trpc.general.content.homeAndLivingBannerRouter.deleteWomenBanner.useMutation(
            {
                onMutate: () => {
