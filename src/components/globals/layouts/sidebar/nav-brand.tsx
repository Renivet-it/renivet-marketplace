                                        ...
                                        {filteredItems.map((subItem) => (
                                            ...
                                            >
                                                <SidebarMenuSubButton
                                                    ...
                                                    className="h-8 overflow-visible rounded-lg px-3 pl-9 text-sm text-sidebar-foreground/75 hover:bg-sidebar-accent/70 hover:text-sidebar-foreground data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-foreground"
                                                >
                                                    <Link
                                                        href={subItem.url}
                                                        prefetch
