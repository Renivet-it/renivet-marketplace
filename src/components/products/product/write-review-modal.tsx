...
export function WriteReviewModal({
    ...
    useEffect(() => {
        if (open && initialVariantId) {
            form.setValue("variantId", initialVariantId);
        }
    }, [form, initialVariantId, open]);
    ...
    function onSubmit(data: ReviewFormValues) {
        ...
        const attributes = [];
        if (data.sizePurchased)
            attributes.push({
                label: "Size Purchased",
                value: data.sizePurchased,
            });
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Share your thoughts about this product with other
                        customers.
                    </DialogDescription>
                </DialogHeader>
                ...
                {isCheckingEligibility ? (
                    ...
                    <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5 text-sm text-neutral-700">
                        Please sign in with the account used for purchase to
                        write a review.
                    </div>
                ) : eligibility && !eligibility.canReview ? (
                    <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-5 text-sm text-neutral-700">
                        Only customers who bought this product can write a
                        review.
                    </div>
                ) : (
                    <Form {...form}>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                ...
                                                >
                                                    ...
                                                    <option value="Runs small">
                                                        Runs small
                                                    </option>
                                                    <option value="True to size">
                                                        True to size
                                                    </option>
                                                    <option value="Runs large">
                                                        Runs large
                                                    </option>
