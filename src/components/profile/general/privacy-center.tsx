            ...
            <CardContent className="space-y-6 px-4 md:px-6">
                ...
                {dataProcessingConsent?.needsReconsent ? (
                    <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">
                        Privacy policy version `{consentState?.version}` requires re-consent before continuing platform use.
                    </div>
                ) : null}
                ...
                <section className="space-y-3">
                    <div>
                        ...
                        <p className="text-sm text-slate-600">
                            This consent is required for account operation, order fulfilment, and customer support.
                        </p>
                    </div>
