...
export function OrdersTable({ initialData, brandData }: PageProps) {
    ...
    const handleExport = async () => {
        ...
        const exportData = dataToUse.flatMap((order) =>
            order.items.map((item) => {
                ...
                return {
                    ...
                    "GST on Commission @18%": formatPriceTag(
                        gstOnCommission,
                        true
                    ),
                    "TCS @1% on Net Taxable Value": formatPriceTag(tcs, true),
                    "Shipping Fee (if charged separately)":
                        formatPriceTag(shippingFee),
                    "Payment Gateway Fee": formatPriceTag(
                        Number(convertPaiseToRupees(paymentGatewayFee)),
                        true
                    ),
                };
            })
        ...
        XLSX.writeFile(
            wb,
            `order-details-${format(new Date(), "yyyy-MM-dd")}.xlsx`
        );
    };

    return (
        <div className="space-y-8 rounded-xl border border-gray-200 bg-white p-8 shadow-lg">
                ...
                <div className="flex flex-wrap items-center gap-6">
                    ...
                    <div className="min-w-[260px]">
                        ...
                        <Input
                            ...
                            className="w-full rounded-md border-gray-300 transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                            value={search}
                            onChange={(e) => {
                                table
                                    .getColumn("id")
                    ...
                    <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="hidden font-medium text-gray-500 sm:block">
                                –
                            </span>
                        </div>
                        <div className="w-[180px]">
                    ...
                    <div className="min-w-[260px]">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant="outline"
                                    className="w-full justify-between rounded-md border-gray-300 bg-white text-gray-700 transition hover:bg-gray-50 focus:ring-2 focus:ring-blue-500"
                                >
                                    {brandIds.length > 0
                            ...
                            <DropdownMenuContent className="max-h-[320px] w-[260px] overflow-y-auto rounded-md border border-gray-200 bg-white shadow-lg">
