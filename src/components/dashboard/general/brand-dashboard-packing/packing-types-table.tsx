...
const columns: ColumnDef<TableBrandProductPacking>[] = [
    { accessorKey: "productType.name", header: "Product Type" },
    {
        ...
        cell: ({ row }) => row.original.packingType?.name ?? "Default",
    },
    {
        ...
        cell: ({ row }) => {
            ...
            if (name === "Fragile Box" || name === "Hard Box") {
    ...
    {
        header: "Own Box",
        cell: ({ row }) => (row.original.shipsInOwnBox ? "Yes" : "No"),
    },
    {
        header: "Override",
        cell: ({ row }) => (row.original.canOverride ? "Yes" : "No"),
    },
    {
    ...
    {
        id: "actions",
        cell: ({ row }) => <BrandProductPackingAction row={row.original} />,
    },
];
