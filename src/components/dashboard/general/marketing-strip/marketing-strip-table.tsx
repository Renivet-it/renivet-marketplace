...
import { MarketingStripAction } from "./marketing-strip-action";

export type TableMarketingStrip = MarketingStrip & {
    status: string;
};

const columns: ColumnDef<TableMarketingStrip>[] = [
    {
        accessorKey: "title",
        header: "Title",
        enableHiding: false,
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const data = row.original;
            return <MarketingStripAction marketingStrip={data} />;
        },
    },
];
...
export function MarketingStripsTable({ initialData }: PageProps) {
