        ...
        cell: ({ row }) => {
            ...
            return req ? (
                <Button
                    variant="outline"
                    size="sm"
                    onClick={() => onView("Shiprocket Request", req)}
                >
                    View
                </Button>
            ) : (
                <span className="italic text-gray-400">No Request</span>
            );
        },
    },
        ...
        cell: ({ row }) => {
            ...
            return res ? (
                <Button
                    variant="outline"
                    size="sm"
                    onClick={() => onView("Shiprocket Response", res)}
                >
                    View
                </Button>
            ) : (
        ...
        cell: ({ row }) => {
            ...
            return log ? (
                <Button
                    variant="outline"
                    size="sm"
                    onClick={() => onView("Order Log", log)}
                >
                    View
                </Button>
            ) : (
                <span className="italic text-gray-400">No Logs</span>
            );
        },
    },
