                ...
                return {
                    ...
                    "Account No.":
                        order.items[0]?.product?.brand.confidential
                            ?.bankAccountNumber || "", // need to add the seller info
                    "IFSC Code":
                        order.items[0]?.product?.brand.confidential
                            ?.bankIfscCode || "", // need to add the seller info
                    "Bank Name":
                        order.items[0]?.product?.brand.confidential?.bankName ||
                        "", // need to add the seller info
                    "Beneficiary Name":
                        order.items[0]?.product?.brand.confidential
                    ...
                    "SUM of GST on COMM.@18%":
                        convertPaiseToRupees(gstOnCommission), // need to add the commission info
                    ...
                    "SUM of DISCOUNT_AMOUNT": convertPaiseToRupees(
