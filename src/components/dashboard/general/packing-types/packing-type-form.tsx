...
export function PackingTypeForm({
    ...
    /* ================= MUTATIONS ================= */
    const createMutation = trpc.general.packingTypes.create.useMutation({
        onSuccess: () => {
    ...
    const updateMutation = trpc.general.packingTypes.update.useMutation({
        onSuccess: () => {
    ...
    return (
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* BASE LENGTH */}
            <div className="space-y-1">
                <label className="text-sm font-medium">Base Length (cm)</label>
                <Input
                    type="number"
                    inputMode="numeric"
                    placeholder="e.g. 30"
            ...
            {/* BASE WIDTH */}
            <div className="space-y-1">
                <label className="text-sm font-medium">Base Width (cm)</label>
                <Input
                    type="number"
                    inputMode="numeric"
                    placeholder="e.g. 20"
            ...
            {/* BASE HEIGHT */}
            <div className="space-y-1">
                <label className="text-sm font-medium">Base Height (cm)</label>
                <Input
                    type="number"
                    inputMode="numeric"
                    placeholder="e.g. 10"
