...
export function BrandTabs() {
    ...
    const hasSettingsPermission = useMemo(() => {
        ...
        return hasPermission(perms.sitePermissions, [
            BitFieldSitePermission.MANAGE_SETTINGS | BitFieldSitePermission.VIEW_SETTINGS,
        ], "any");
    }, [user]);
    ...
    const tabs = useMemo(() => {
        ...
        if (hasSettingsPermission) {
            list.push({
                name: "Waitlist",
                href: "/dashboard/general/brand-waitlist",
                icon: "Clock" as const,
            });
        }
