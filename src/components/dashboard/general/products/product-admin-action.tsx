                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuGroup>
                        ...
                        <DropdownMenuItem asChild>
                            <Link href={`/dashboard/general/products/preview-form/${product.id}/values`} target="_blank">
                        ...
                        <DropdownMenuItem asChild>
                            <Link href={`/dashboard/general/products/preview-form/${product.id}/journey`} target="_blank">
