...
export type TableAdvertisement = Advertisement & {
    status: string;
};

const columns: ColumnDef<TableAdvertisement>[] = [
    {
        accessorKey: "title",
        header: "Title",
        enableHiding: false,
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const data = row.original;
            return <AdvertisementAction advertisement={data} />;
        },
    },
];
...
export function AdvertisementsTable({ initialData }: PageProps) {
