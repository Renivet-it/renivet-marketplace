...
import {
    ...
    monitoringSlaQueries,
    orderQueries,
    planQueries,
    productQueries,
    productTypeQueries,
    corporateOrderQueries,
...
export const createContextInner = ({ req, auth, user }: ContextProps) => {
    return {
        ...
        queries: {
            ...
            financeCompliance: financeComplianceQueries,
            legal: legalQueries,
            marketing: marketingQueries,
            marketingStrips: marketingStripQueries,
            monitoringSla: monitoringSlaQueries,
            orders: orderQueries,
            corporateOrders: corporateOrderQueries,
