...
export const productReviewsRouter = createTRPCRouter({
    ...
    approveProduct: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            ...
            await auditEntityChange({
                actorId: user.id,
                actionType: "product_approved_for_go_live",
                entityType: "product",
                entityId: productId,
                beforeValue: {
                ...
                reason: "product_approved_go_live",
            });
    ...
    rejectProduct: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            ...
            await auditEntityChange({
                actorId: user.id,
                actionType: "product_rejected_for_go_live",
                entityType: "product",
                entityId: id,
                beforeValue: {
                    verificationStatus: existingProduct.verificationStatus,
                ...
                reason: rejectionReason ?? "product_review_rejected",
            });
