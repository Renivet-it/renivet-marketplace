...
export const newHomePageBagSectionRouter = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getHomePageBagSectionections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getHomePageBagSectionection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createHomePageBagSectionection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: input.title ?? null,
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updateHomePageBagSectionection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deleteHomePageBagSectionection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const newHomePagEventSectionTwoRouter = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getHomePageEventTwoSections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getHomePageEventTwoSection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createHomePageEventTwoSection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: "",
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updateHomePageEventTwoSection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deleteHomePageEventTwoSection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const newHomePagEventSectionOneRouter = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getHomePageEventOneSections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getHomePageEventOneSection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createHomePageEventOneSection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: "",
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updateHomePageEventOneSection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deleteHomePageEventOneSection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const newHomePagEffortlessRouter = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getHomePageEffortlessEleganceSections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getHomePageEffortlessEleganceSection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createHomePageEffortlessEleganceSection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: "",
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updateHomePageEffortlessEleganceSection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deleteHomePageEffortlessEleganceSection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const kidsGentleCareSection = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getkidGentleCareSections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getkidGentleCareSection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createkidGentleCareSection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: "",
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updatekidGentleCareSection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deletekidGentleCareSection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const kidsFrostyFormalSection = createTRPCRouter({
    getwomenHomeBanners: publicProcedure
        .input(
            z.object({
                limit: z.number().int().positive().default(10),
        ...
        .query(async ({ ctx, input }) => {
            ...
            const homeShopByCategories =
                await queries.womenhomebanner.getkidFrostyFormalShirtSections({
                    limit,
                    page,
                });
            return homeShopByCategories;
    ...
    getwomenHomeBanner: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            const existingHomeShopByCategory =
                await queries.womenhomebanner.getkidFrostyFormalShirtSection(id);
            if (!existingHomeShopByCategory)
                throw new TRPCError({
                    code: "NOT_FOUND",
                    message: "Home shop by category not found",
    ...
    createWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const newHomeShopByCategory =
                await queries.womenhomebanner.createkidFrostyFormalShirtSection({
                    ...input,
                    imageUrl: input.imageUrl,
                    title: "",
                    isActive: false
    ...
    updateWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            const updatedHomeShopByCategory =
                await queries.womenhomebanner.updatekidFrostyFormalShirtSection(
                    id,
                    {
                        ...values,
                        imageUrl: values.imageUrl,
    ...
    deleteWomenBanner: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            await Promise.all([
                queries.womenhomebanner.deletekidFrostyFormalShirtSection(id),
                utApi.deleteFiles([existingKey]),
            ]);
...
export const contentRouter = createTRPCRouter({
    ...
    newHomePagEffortlessRouter: newHomePagEffortlessRouter,
    kidsGentleCareSection: kidsGentleCareSection,
    kidsFrostyFormalSection: kidsFrostyFormalSection,
    newHomePagEventSectionOneRouter:newHomePagEventSectionOneRouter,
    newHomePagEventSectionTwoRouter: newHomePagEventSectionTwoRouter,
    newHomePageBagSectionRouter: newHomePageBagSectionRouter
});
