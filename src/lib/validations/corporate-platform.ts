...
export const corporateDocumentSettingsInputSchema = z.object({
    ...
    operationalAddressLine1: z.string().trim().max(300).nullable().optional(),
    operationalAddressLine2: z.string().trim().max(300).nullable().optional(),
    operationalCity: z.string().trim().max(100).nullable().optional(),
    operationalState: z.string().trim().max(100).nullable().optional(),
    operationalPostalCode: z.string().trim().max(12).nullable().optional(),
    operationalCountry: z.string().trim().max(100).nullable().optional(),
