...
// womenMoodBoardSection
    ...
    async getAllKidsBannerSections({
        limit,
        page,
    }: {
        limit: number;
    ...
    async getAllKidsBannerSection(id: string) {
    ...
    async createKidsBannerSections(
        values: createWomenBrandProduct & {
            imageUrl: string;
        }
    ) {
    ...
    async updateKidsBannerSections(
        id: string,
        values: UpdateHomeShopByCategory & {
            imageUrl: string;
        }
    ...
    async deleteKidsBannerSections(id: string) {
        const data = await db
...
//kids explore category section

        async getKidsExploreSections(p0: { limit: number; page: number; }) {
    ...
    async getAllKidsExploreSections({
        limit,
        page,
    }: {
        limit: number;
    ...
    async getAllKidsExploreSection(id: string) {
    ...
    async createKidsExploreSections(
        values: createWomenBrandProduct & {
            imageUrl: string;
        }
    ) {
    ...
    async updateKidsExploreSections(
        id: string,
        values: UpdateHomeShopByCategory & {
            imageUrl: string;
        }
    ...
    async deleteKidsExploreSections(id: string) {
        const data = await db
