...
export const corporateDocumentSettings = pgTable(
    "corporate_document_settings",
    {
        ...
        operationalAddressLine1: text("operational_address_line_1"),
        operationalAddressLine2: text("operational_address_line_2"),
        operationalCity: text("operational_city"),
        operationalState: text("operational_state"),
        operationalPostalCode: text("operational_postal_code"),
        operationalCountry: text("operational_country"),
        email: text("email"),
        phone: text("phone"),
