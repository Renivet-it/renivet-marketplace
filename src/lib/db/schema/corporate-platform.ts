...
export const corporateDocumentSettings = pgTable(
    "corporate_document_settings",
    {
        ...
        email: text("email"),
        phone: text("phone"),
        bankName: text("bank_name").default("IDFC"),
        bankAccountName: text("bank_account_name").notNull().default("Renivet"),
        bankAccountNumber: text("bank_account_number").default("73564993505"),
        bankAccountType: text("bank_account_type"),
        bankIfscCode: text("bank_ifsc_code").default("IDFB0090174"),
