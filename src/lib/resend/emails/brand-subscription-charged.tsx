...
export default function BrandSubscriptionCharged({
    brand = {
    ...
    return (
        <Layout
            ...
            heading="Payment confirmation for your subscription"
        >
            <p>Hi {brand.name},</p>
            ...
            <p>
                You were charged{" "}
                <strong>
                    {formatPriceTag(+convertPaiseToRupees(plan.amount))}
                </strong>{" "}
                for the{" "}
                <strong>
                    &ldquo;{plan.name}
                ...
                plan. Your subscription is now active.
            </p>
