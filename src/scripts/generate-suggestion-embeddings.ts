...
async function main() {
    console.log("Starting search suggestion embedding generation...");
    ...
    for (const product of allProducts) {
        try {
            ...
            // Format: [Meta Keywords] [Category] [SubCategory] [ProductType] [Brand]
            const parts = [
            ...
            // console.log(`  Reference Text: ${embeddingText}`);
            ...
            await db
                .update(products)
                .set({
                    searchSuggestionEmbeddings: embedding,
                })
