        ...
        >
            <div className="relative z-40 w-full max-w-lg space-y-5 overflow-hidden rounded-xl border border-foreground/10 bg-card p-6 backdrop-blur-md backdrop-saturate-150 md:p-10">
                ...
                <div className="space-y-5 text-sm">
                    <p>We&apos;re planting the seeds of a greener future. 🌲</p>

                    <p>
                        Our sustainable marketplace is under construction, but
                        we&apos;re working hard to bring you a shopping
                        experience that&apos;s kind to the planet. 🌍
                    </p>

                    <p>
                        Stay tuned for a harvest of eco-friendly products and
                        ethical brands. 🌿
                    </p>
                    ...
                    <p>
                        Be the first to know when we launch and get sustainable
                        living tips. Sign up now!
                    </p>
                </div>
