...
} from "@/components/dashboard/general/home/brand-introdeuction-banner/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/home-page/brand-introduction/new">
