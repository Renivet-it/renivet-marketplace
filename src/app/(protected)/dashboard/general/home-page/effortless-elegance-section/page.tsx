...
} from "@/components/dashboard/general/home/effortless-elegance-section/shop-by-categories-table";
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Effortless Section Banner</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Effortless Section Banner
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/home-page/effortless-elegance-section/new">
