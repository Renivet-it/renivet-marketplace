...
} from "@/components/dashboard/general/home/bag-section-cards/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/home-page/bag-section/new">
                        <Icons.PlusCircle className="size-5" />
                        New Bag Section Banner
                    </Link>
                </Button>
            </div>
