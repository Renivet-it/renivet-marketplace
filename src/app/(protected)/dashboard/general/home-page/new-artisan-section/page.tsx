...
} from "@/components/dashboard/general/home/new-artisan-banner/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/home-page/new-artisan-section/new">
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getHomePageNewArtisanSections({
            limit,
            page,
        }),
