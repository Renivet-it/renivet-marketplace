...
} from "@/components/dashboard/general/kids/frosty-fromal/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/kids/frosty-formal/new">
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getkidFrostyFormalShirtSections({
            limit,
            page,
        }),
