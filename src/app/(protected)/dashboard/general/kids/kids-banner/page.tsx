...
} from "@/components/dashboard/general/kids/banners/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/kids/kids-banner/new">
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getKidsBannerSections({
            limit,
            page,
        }),
