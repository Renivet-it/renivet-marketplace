...
} from "@/components/dashboard/general/kids/twining-section/shop-by-categories-table";
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Twining Section</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Twining Section
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/kids/twining-section/new">
