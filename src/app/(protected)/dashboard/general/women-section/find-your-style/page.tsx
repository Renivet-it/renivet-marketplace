...
} from "@/components/dashboard/general/women/find-your-style/shop-by-categories-table";
...
export const metadata: Metadata = {
    ...
    description: "Manage the platform's Find Your Style",
};
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Find Your Style</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Find Your Style
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/women-section/find-your-style/new">
                        <Icons.PlusCircle className="size-5" />
                        New women Find Your Style
                    </Link>
                </Button>
            </div>
...
// ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getWomenSummerSaleSections({
            limit,
            page,
        }),
    ]);
