...
} from "@/components/dashboard/general/women/brand-story-telling/shop-by-categories-table";
...
export const metadata: Metadata = {
    ...
    description: "Manage the platform's Brand Story Telling",
};
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Brand Story telling</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Brand Story telling
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/women-section/brand-story-telling/new">
                        <Icons.PlusCircle className="size-5" />
                        New Brand Story telling
                    </Link>
                </Button>
            </div>
...
// ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getwomenBranStoryTellingSections({
            limit,
            page,
        }),
    ]);
