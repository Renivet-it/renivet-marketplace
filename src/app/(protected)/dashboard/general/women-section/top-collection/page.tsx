...
} from "@/components/dashboard/general/women/top-collection/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/women-section/top-collection/new">
                        <Icons.PlusCircle className="size-5" />
                        New women top collection
                    </Link>
                </Button>
            </div>
