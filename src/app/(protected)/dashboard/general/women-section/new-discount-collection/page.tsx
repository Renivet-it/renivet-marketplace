...
} from "@/components/dashboard/general/women/new-discount-collection/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/women-section/new-discount-collection/new">
                        <Icons.PlusCircle className="size-5" />
                        New women New discount Collection
                    </Link>
                </Button>
            </div>
...
// ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getnewCollectionDiscountSection({
            limit,
            page,
        }),
    ]);
