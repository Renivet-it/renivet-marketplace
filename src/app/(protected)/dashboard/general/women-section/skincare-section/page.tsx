...
} from "@/components/dashboard/general/women/skincare-women/shop-by-categories-table";
...
export const metadata: Metadata = {
    title: "Skincare Solution",
    description: "Manage the platform's Skincare Solution",
};
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Skincare Solution</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Skincare Solution
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/women-section/skincare-section/new">
                        <Icons.PlusCircle className="size-5" />
                        New Skincare Solution
                    </Link>
                </Button>
            </div>
...
// ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getwomenBrandSkinCareSections({
            limit,
            page,
        }),
    ]);
