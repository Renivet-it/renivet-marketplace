...
} from "@/components/dashboard/general/home-living/curate-concious/shop-by-categories-table";
...
export const metadata: Metadata = {
    ...
    description: "Manage the platform's Curate Concious Section",
};
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Curate Concious Section</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Curate Concious Section
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/home-living/curate-concious/new">
                        <Icons.PlusCircle className="size-5" />
                        New Curate Concious section
                    </Link>
                </Button>
            </div>
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.gethomeAndLivingCurateConciousSections({
            limit,
            page,
        }),
