...
} from "@/components/dashboard/general/men/elavate-looks/shop-by-categories-table";
...
export const metadata: Metadata = {
    title: "Elavate Your Looks",
    description: "Manage the platform's Elavate Your Looks",
};
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Elavate Your Looks</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Elavate Your Looks
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/men-section/elavate-looks/new">
                        <Icons.PlusCircle className="size-5" />
                        New Elavate Your Looks
                    </Link>
                </Button>
            </div>
