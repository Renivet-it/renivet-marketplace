...
} from "@/components/dashboard/general/men/suggested-looks/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/men-section/suggested-looks/new">
...
// @ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getSuggestedLooksForYous({
            limit,
            page,
        }),
    ]);
