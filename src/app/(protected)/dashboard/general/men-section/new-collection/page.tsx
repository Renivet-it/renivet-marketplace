...
} from "@/components/dashboard/general/men/new-collection/shop-by-categories-table";
    ...
    return (
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                ...
                >
                    <Link href="/dashboard/general/men-section/new-collection/new">
...
//@ts-ignore
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getMenNewCollections({
            limit,
            page,
        }),
    ]);
