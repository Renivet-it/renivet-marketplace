...
} from "@/components/dashboard/general/beauty-personal/best-seller/shop-by-categories-table";
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Beauty and Personal Best Seller Banner</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Beauty and Personal Best Seller Banner
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/beauty-personal/best-seller/new">
                        <Icons.PlusCircle className="size-5" />
                        New Beauty and Best Seller Banner
                    </Link>
                </Button>
            </div>
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getBeautyBestSellerSections({
            limit,
            page,
        }),
