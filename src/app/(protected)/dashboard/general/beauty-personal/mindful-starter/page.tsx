...
} from "@/components/dashboard/general/beauty-personal/mindful-banner/shop-by-categories-table";
        ...
        <DashShell>
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-2">
                <div className="space-y-1 text-center md:text-start">
                    <h1 className="text-2xl font-bold">Beauty and mindful starter Banner</h1>
                    <p className="text-balance text-sm text-muted-foreground">
                        Manage the platform&apos;s Beauty and mindful starter Banner
                    </p>
                </div>
                ...
                >
                    <Link href="/dashboard/general/beauty-personal/mindful-starter/new">
                        <Icons.PlusCircle className="size-5" />
                        New Beauty and mindful starter Banner
                    </Link>
                </Button>
            </div>
...
async function ShopByCategoriesFetch({ searchParams }: PageProps) {
    ...
    const [data] = await Promise.all([
        WomenHomeSectionQueries.getBeautyMindFulSections({
            limit,
            page,
        }),
