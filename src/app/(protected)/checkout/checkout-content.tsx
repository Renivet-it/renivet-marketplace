            ...
            return [
                {
                    ...
                    swapRewardRedemptionId:
                        rewardCheckoutQuery.data?.redemption.id,
                    createdAt:
                        checkoutItem.product.createdAt ??
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs leading-5 text-[#7b643b]">
                                    Your reward line stays {formatPriceTag(0)}{" "}
                                    in checkout, and you can still purchase
                                    regular items alongside it.
                                </p>
                            </div>
                        </div>
                    </div>
